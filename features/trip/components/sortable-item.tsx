...
export const SortableItem = ({ item }: SortableItemProps) => {
  ...
  return (
    <div
      ...
      className="p-4 border rounded-md flex justify-between items-center hover:shadow transition-shadow bg-white"
    >
      <div>
        <h4 className="text-gray-800 font-medium capitalize">
          {item.locationTitle}
        </h4>
